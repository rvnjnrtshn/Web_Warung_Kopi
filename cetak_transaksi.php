...
<body>
  ...
  <page size="dipakai" layout="landscape">
    ...
    ?>
      <center>
        <h4>
          Warung Kopi CEPAT SAJI
        </h4>
        <span>
          Sei Beluru Dusun II Kec. Meranti Kab. Asahan<br>
          Telp. +62 823-6567-1762 || E-mail revasiahaan66@gmail.com
        </span>
      </center>
            <hr>
            ...
            <center>
              <h5>
                TERIMAKASIH ATAS KUNJUNGANNYA, JANGAN LUPA DATANG KEMBALI ^_^
              </h5>
            </center>
            <hr>
